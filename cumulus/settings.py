...
CROPS = ['AMARANTH', 'AMMI', 'ARTEMESIA', 'ASTER', "BACHELOR'S BUTTON", 'BASIL', 
         'BASKET FLOWER', 'BORAGE', 'BUPLEURUM', 'CALENDULA', 'CELOSIA', 'CERINTHE', 
         'CHAMOMILE', 'CHERVIL', 'CHINESE FORGET-ME-NOT', 
         'CHRYSANTHEMUM', 'CILANTRO', 'CLEOME', 'COLUMBINE', 'COREOPSIS', 'COSMOS', 
         'CRASPEDIA', 'DATURA', 'DELPHINIUM', 'DIANTHUS', 'DIDISCUS', 
         'DILL', 'ECHINACEA', 'EDIBLE FLOWER MIX', 'ERYNGIUM', 'FLAX', "FOUR O'CLOCKS", 
         'FOXGLOVE', 'GOMPHRENA', 'GRASS', 'GYPSOPHILA', 'HYSSOP', "JACOB'S LADDER", 
         'LARKSPUR', 'LICORICE MINT', 'LINARIA', 'MARIGOLD', 'MARSHMALLOW', 'MIGNONETTE', 
         'MILLET', 'MONARDA', 'MORNING GLORY', 'MULLEIN', 'NASTURTIUM', 'NEPITELLA', 
         'NICOTIANA', 'NIGELLA', 'ORLAYA', 'PARSLEY', 'PHACELIA', 'PHLOX', "POOR MAN'S ORCHID", 
         'POPPY', 'RUDBECKIA', 'SAINFOIN', 'SALVIA', 'SAPONARIA', 'SCABIOSA', 'SNAPDRAGON', 
         'STATICE', 'STRAWFLOWER', 'SUNFLOWER', 'SWEET PEA', 'TRIGONELLA', 'VERBENA', 
         'YARROW', 'ZINNIA']
# CROPS = ['AMARANTH', 'AMMI', "ARTEMESIA", "BACHELOR'S BUTTON", 'BASKET FLOWER', 'BORAGE', 'BUPLEURUM', 'CALENDULA', 'CELOSIA', 'CERINTHE', 'CHINA ASTER', 
#          'CHINESE DELPHINIUM', 'CHINESE FORGET-ME-NOT', 'CLEOME', 'COLUMBINE', 'COREOPSIS', 'COSMOS', 'COSMOS SULPHUREUS', 'CRASPEDIA', 
#          'DATURA WRIGHTII', 'DELPHINIUM', 'DIANTHUS', 'DIDISCUS', 'EDIBLE FLOWER MIX', 'ERYNGIUM', 'FLAX', "FOUR O'CLOCKS", 'FOXGLOVE', 'GOMPHRENA', 'GYPSOPHILA', 
#          "JACOB'S LADDER", 'LARKSPUR', 'LINARIA', 'MARIGOLD', 'MIGNONETTE', 'MILLET', 'MORNING GLORY', 'MULLEIN, TURKISH', 'MULLEIN, VERBASCUM', 'NASTURTIUM', 
#          'NICOTIANA', 'NIGELLA BUCHARICA', 'NIGELLA HISPÁNICA', 'NIGELLA PAPILLOSA', 'ORLAYA', 'ORNAMENTAL GRASS', 'PEARL YARROW', 'PHACELIA TANACETIFOLIA', 'PHLOX', "POOR MAN'S ORCHID",
#          'POPPY', 'POPPY, BREADSEED', 'POPPY, CALIFORNIA', 'POPPY, ICELAND', 'POPPY, PEONY', 'POPPY, SHIRLEY', 'RUDBECKIA', 'RUDBECKIA TRILOBA', 
#          'SAINFOIN', 'SALVIA', 'SAPONARIA', 'SCABIOSA', 'SIBERIAN YARROW', 'SNAPDRAGON', 'STATICE', 'STRAWFLOWER', 'SUNFLOWER', 'SUNFLOWER, MEXICAN', 
...
#          'PARSLEY, FLATLEAF', 'TRIGONELLA', 'VERBENA', 'YARROW']
...
SUBTYPES = ["AMARANTH", "BREADSEED", "CALIFORNIA", "CHINA", "CHINESE", "FLATLEAF", "GERMAN", "ICELAND", "MEXICAN (TITHONIA)", 
