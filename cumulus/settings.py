...
SUBTYPES = ["AMARANTH", "BREADSEED", "CALIFORNIA", "CHINA", "CHINESE", "COMMON", "FLATLEAF", "GERMAN", "ICELAND", "MEXICAN (TITHONIA)", 
            "ORNAMENTAL","PEARL", "PEONY", "PHOENICIAN", "PURPUREA", "SACRED BASIL", "SHIRLEY", "SIBERIAN","TRAILING", "TURKISH"]
